...
public class OthersController implements Initializable {
    ...
    void FixedDeposit(ActionEvent event) throws IOException {
        ...
        stage.close();
        FXMLLoader fxmlLoader=new FXMLLoader(getClass().getResource("fixdep.fxml"));
    ...
    void checkbalance(ActionEvent event) throws IOException {
        ...
        stage.close();
        FXMLLoader fxmlLoader=new FXMLLoader(getClass().getResource("chbalance.fxml"));
        Parent root1 = (Parent) fxmlLoader.load();
        Stage st = new Stage();
        st.setScene(new Scene(root1));
        st.show();
    ...
    void updateinformation(ActionEvent event) throws IOException {
        ...
        stage.close();
        FXMLLoader fxmlLoader=new FXMLLoader(getClass().getResource("Profinfo.fxml"));
        Parent root1 = (Parent) fxmlLoader.load();
        Stage st = new Stage();
        st.setScene(new Scene(root1));
        st.show();
