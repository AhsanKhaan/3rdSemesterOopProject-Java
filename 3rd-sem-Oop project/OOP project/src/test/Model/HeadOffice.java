    ...
    public void readBalance(String name, double acc_no, double br_code, int pin, String path) throws FileNotFoundException, IOException {
        ...
        for (int i = 0; i < Customers.size(); i++) {
            ...
            if ((name.equals(split[0])) && (acc_no == Double.parseDouble(split[1])) && (br_code == Double.parseDouble(split[2])) && (pin == (Integer.parseInt(split[3]) ^ 957))) {
                bal1 = split[4];
                if (path.equals("C:\\Users\\Hp\\Documents\\NetBeansProjects\\test_2\\src\\test\\monthlysavingaccount.txt") || path.equals("C:\\Users\\Hp\\Documents\\NetBeansProjects\\test_2\\src\\test\\fixeddepositaccount.txt")) {
                    day = Double.parseDouble(split[10]);
                    month = Double.parseDouble(split[11]);
                    year = Double.parseDouble(split[12]);
                }
                if (path.equals("C:\\Users\\Hp\\Documents\\NetBeansProjects\\test_2\\src\\test\\fixeddepositaccount.txt")) {
...
//                    System.out.println("Your Account Number is: " + account_no + " and Branch Code is: " + Information.get(2) + " and you got: " + profit + " after 10 years");
    ...
    public int checkpassward(PasswordField passward) throws FileNotFoundException, IOException {
        File f = new File("C:\\Users\\Hp\\Documents\\NetBeansProjects\\test_2\\src\\test\\passward.txt");
        FileReader fr = new FileReader(f);
        BufferedReader br = new BufferedReader(fr);
    ...
    public void changePassward(PasswordField newpassword) throws FileNotFoundException, IOException {
        File f1 = new File("C:\\Users\\Hp\\Documents\\NetBeansProjects\\test_2\\src\\test\\passward.txt");
        FileOutputStream fos = new FileOutputStream(f1);
        BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(fos));
    ...
    public int checkRequests() throws FileNotFoundException, IOException {
        File f = new File("C:\\Users\\Hp\\Documents\\NetBeansProjects\\test_2\\src\\test\\requests.txt");
        FileReader fr = new FileReader(f);
        BufferedReader br = new BufferedReader(fr);
        while ((line = br.readLine()) != null) {
            Customers.add(line);
        ...
        if (Customers.size() <= 1) {
            File f1 = new File("C:\\Users\\Hp\\Documents\\NetBeansProjects\\test_2\\src\\test\\requests.txt");
            FileOutputStream fos = new FileOutputStream(f1);
            BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(fos));
            for (int j = 0; j < Customers.size(); j++) {
                bw.write(Customers.get(j));
            ...
            if (split[split.length - 1].equals("savingaccount")) {
                path1 = "C:\\Users\\Hp\\Documents\\NetBeansProjects\\test_2\\src\\test\\savingaccount.txt";
                type = split[split.length - 1];
            } else if (split[split.length - 1].equals("currentaccount")) {
                path1 = "C:\\Users\\Hp\\Documents\\NetBeansProjects\\test_2\\src\\test\\currentaccount.txt";
                type = split[split.length - 1];
            } else if (split[split.length - 1].equals("monthlysavingaccount")) {
                path1 = "C:\\Users\\Hp\\Documents\\NetBeansProjects\\test_2\\src\\test\\monthlysavingaccount.txt";
                type = split[split.length - 1];
            } else if (split[split.length - 1].equals("fixeddepositaccount")) {
                path1 = "C:\\Users\\Hp\\Documents\\NetBeansProjects\\test_2\\src\\test\\fixeddepositaccount.txt";
